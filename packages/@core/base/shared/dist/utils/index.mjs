...
/** @type {import("/Users/zhichao.zhang/huayin-person-manager/packages/@core/base/shared/src/utils/index.js")} */
const _module = await jiti.import("/Users/zhichao.zhang/huayin-person-manager/packages/@core/base/shared/src/utils/index.ts");
