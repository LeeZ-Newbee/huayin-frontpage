...
const jiti = createJiti(import.meta.url, {
  "interopDefault": true,
  "alias": {
    "@vben/node-utils": "E:/GitHub/huayin-person-manager/internal/node-utils"
  },
  "transformOptions": {
    "babel": {
      "plugins": []
...
/** @type {import("E:/GitHub/huayin-person-manager/internal/node-utils/src/index.js")} */
const _module = await jiti.import("E:/GitHub/huayin-person-manager/internal/node-utils/src/index.ts");
