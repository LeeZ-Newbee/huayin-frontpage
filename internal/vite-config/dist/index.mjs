...
const jiti = createJiti(import.meta.url, {
  "interopDefault": true,
  "alias": {
    "@vben/vite-config": "/Users/zhichao.zhang/vue-vben-admin/internal/vite-config"
  },
  "transformOptions": {
    "babel": {
      "plugins": []
...
/** @type {import("/Users/zhichao.zhang/vue-vben-admin/internal/vite-config/src/index.js")} */
const _module = await jiti.import("/Users/zhichao.zhang/vue-vben-admin/internal/vite-config/src/index.ts");
